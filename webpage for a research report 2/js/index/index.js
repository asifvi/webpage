...
Highcharts.chart('peer_comparison_chart', {
    ...
    xAxis: {
        categories: ['Cost / <br> Income Ratio', 'Net Income /<br> Tangible Assets', 'Net Interest <br>Margin', 'Problem Loans /<br> Gross Loans'],
        title: {
            text: ''
        },
        gridLineWidth: 1,
...
Highcharts.chart('profit_by_seg_chart', {
    ...
    xAxis: {
        ...
        crosshair: true,
        labels: {
            enabled: true // hide the xAxis labels
        },
        accessibility: {
            description: ''
        }
...
Highcharts.chart('liquid_assets_chart', {
	...
	legend: {
        ...
        floating: false,
        shadow: false,
        enabled: false // Ensure the legend is enabled
    },
